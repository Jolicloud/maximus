...
static void
on_binding_changed (GConfClient        *client,
                    guint               cid,
                    GConfEntry         *entry,
                    MaximusBind         *bind)
{
  ...
  priv->binding = gconf_client_get_string (client, 
                                           BIND_EXCLUDE_CLASS, 
                                           NULL);
...
maximus_bind_init (MaximusBind *bind)
{
  ...
  gconf_client_add_dir (client, BIND_PATH, GCONF_CLIENT_PRELOAD_NONE, NULL);

  priv->binding = gconf_client_get_string (client, 
                                           BIND_EXCLUDE_CLASS, 
                                           NULL);
  gconf_client_notify_add (client, BIND_EXCLUDE_CLASS,
                           (GConfClientNotifyFunc)on_binding_changed,
                           bind, NULL, NULL);
